<div id="notificacion">
   <div class="p-1 space-y-4" id="container_notification_{{$identificador}}">
    @if($tipo=="default")
      <div class="flex w-96 shadow-lg rounded-lg" id="not_main">
        ...
        <div class="px-4 py-6 bg-white rounded-r-lg flex justify-between items-center w-full border border-l-transparent border-gray-200">
          <div>{{ $texto }}</div>
          <button class="closeNotification" id="closeNotification_{{$identificador}}">
